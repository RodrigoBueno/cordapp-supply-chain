    ...
    class Initiator(val idPedido: UniqueIdentifier,
        ...
        override fun call(): SignedTransaction {
            ...
            requireThat {
                ...
                "A transportadora tem que ser a Transportadora." using (
                        transportadora.name.organisation == "Transportadora")
            }
            ...
            val comando = Command(PedidoContract.Commands.Enviar(),
                    outrosParticipantes
